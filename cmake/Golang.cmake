...
function(ADD_GO_PACKAGE_FOLDER)
	...
	get_filename_component(GO_PACKAGE_MAIN_FOLDER_COPY_DEST ${GO_PACKAGE_GOPATH_MAIN_FOLDER} DIRECTORY)

	# Add custom commands to copy the necessary files over
	# add_custom_command(TARGET ${GO_PACKAGE_TARGET}_copy
	# 		COMMAND ${CMAKE_COMMAND} -E
	# 		copy ${GO_PACKAGE_ABSOLUTE_COPY_FILES} ${GO_PACKAGE_MAIN_FOLDER_COPY_DEST}
	# 		# The copy command depends on all of the files that need aren't to be configured
	# 		DEPENDS ${GO_PACKAGE_ABSOLUTE_COPY_FILES})
